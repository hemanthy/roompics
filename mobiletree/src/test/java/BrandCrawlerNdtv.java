...
public class BrandCrawlerNdtv {
	...
	public BrandCrawlerNdtv(String url,SessionFactory sessionFactory,MobileService mobileServiceImpl) throws IOException, ClassNotFoundException, SQLException {
		this.url = url;
	...
	public void getandSaveMobileInfo(Element element) throws IOException, ClassNotFoundException, SQLException{
		...
		if (content == null) {
			...
			MobileCrawlerNdtv mobileCrawlerNdtv = new MobileCrawlerNdtv(mobileUrl,brandTitle);
			presistCrawelData.setMobile(mobileCrawlerNdtv.mobile);
