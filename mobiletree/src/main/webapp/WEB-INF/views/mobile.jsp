                ...
                <div class="product-key-features">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="key-feature">
                            ...
                            <span class="feature-value" title="1.5 GHz, Quad Core Med...">:  1.5 GHz, Quad Core Med..</span>
                        </div>
                        <div class="key-feature">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                ...
                <c:if test="${!empty company.mobile}">
	                <hr>
	                <div id="border-color-div" class="panel panel-info">
	                    <div class="panel-heading">
	                        <h3 class="panel-title">${mobile.company.brandName} Mobiles</h3>
	                    </div>
						<div id="mobile-left-nav-sect">
							<div class="panel-body">
								<div class="panel-body-id">
									<ul>
										<c:forEach items="${company.mobile}" var="mobile"
